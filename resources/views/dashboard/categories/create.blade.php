...
@section('content')
    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="card-title">{{ __('translation.Add New Category') }}</h5>
            <hr />
            <form class="form-body mt-4" method="post" action="{{ route('category.store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-lg-8">
                        <div class="border border-3 p-4 rounded">
                            <div class="mb-3">
                                ...
                                <input required name="name_en" value="{{  old('name_en') }}" type="text"
                                    ...
                                    placeholder="International Brandnig">
                                @error('name_en')
                    ...
                    <div class="col-lg-4">
                        <div class="border border-3 p-4 rounded">
                            <div class="row g-3">
                                ...
                                <div class="col-12 childs" style="display:{{ old('parent' , 1) == 0 ? 'block' : 'none' }};">
                                ...
                                <div class="col-12">
                                    <div class="card-body">
                                        ...
                                        <div class="form-check">
                                            <input required {{ old('parent' , 1 ) == 1 ? 'checked' : ''  }} name="parent" class="form-check-input" type="radio"
                                                value="1" id="parent">
                                            <label class="form-check-label" for="parent">{{ __('translation.Yes') }}</label>
                                        </div>

                                        <div class="form-check">
                                            <input required {{ old('parent' ,1) == 0 ? 'checked' : ''  }} name="parent" class="form-check-input" type="radio"
