...
@section('content')
    <div class="card">
        <div class="card-body p-4">
            <h5 class="card-title">{{ __('translation.Edit Store') }}</h5>
            <hr />
            <form class="form-body mt-4" method="post" action="{{ route('stores.update' , $store) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                @method('put')
                <div class="row">
                    <div class="col-lg-8">
                        <div class="border border-3 p-4 rounded">
                            ...
                            <div class="mb-3">
                                ...
                                <input required name="name" value="{{ old('name', $store->name) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input required name="store_name" value="{{ old('store_name' , $store->store_name) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input required name="email" value="{{ old('email',$store->email) }}" type="email"
                            ...
                            <div class="mb-3">
                                ...
                                <input required name="phone" value="{{ old('phone',$store->phone) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input required name="other_phone" value="{{ old('other_phone',$store->other_phone) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input required name="address" value="{{ old('address',$store->address) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input required name="website" value="{{ old('website',$store->website) }}" type="url"
                            ...
                            <div class="mb-3">
                                ...
                                <select requierd name="active"
                                    ...
                                    <option value="1" {{ old('active',$store->active) === 1 ? 'selected' : '' }}>
                                        {{ __('translation.Active') }}</option>
                                    <option value="0" {{ old('active',$store->active) === 0 ? 'selected' : '' }}>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="text-center">
                                        @if ($store->image)
                                            <img style="margin:20px auto" src="{{ url('storage/'.$store->image) }}" class="ml-3 rounded-circle p-1 border" width="90" height="90" alt="...">
                                        @else
                                            <img style="margin:20px auto" src="{{ url('dashboard/assets/images/store.png') }}" class="ml-3 rounded-circle p-1 border" width="90" height="90" alt="...">
                                        @endif
                                    </div>
                                        ...
                                        <select requierd name="country_id"
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->id }}"
                                                    {{ old('country_id',$store->country_id) == $country->id ? 'selected' : '' }}>
                                                    {{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('country_id')
                                        ...
                                        <select requierd name="activity_id"
                                            ...
                                            @foreach ($activities as $activity)
                                                <option value="{{ $activity->id }}"
                                                    {{ old('activity_id',$store->activity_id) == $activity->id ? 'selected' : '' }}>
