...
@section('content')
    <div class="card">
        <div class="card-body p-4">
            ...
            <hr />
            <form class="form-body mt-4" method="post" action="{{ route('color.update', $color) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                @method('put')
                <div class="row">
                    <div class="col-lg-8">
                        <div class="border border-3 p-4 rounded">
                            <div class="mb-3">
                                ...
                                <input required name="title_en" value="{{ old('title_en',$color->title_en) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input required name="title_ar" value="{{  old('title_ar',$color->title_ar) }}" type="text"
                    ...
                    <div class="col-lg-4">
                        <div class="border border-3 p-4 rounded">
                            <div class="mb-3">
                                ...
                                <input  required name="color" value="{{ old('color' ,$color->color) }}" type="color"
