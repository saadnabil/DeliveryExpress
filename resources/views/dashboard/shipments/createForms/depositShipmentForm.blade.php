 <form id="depositShipmentForm" style="display:{{ old('shipment_type_id') == 3 ? 'block' : 'none' }};" class="form-body" method="post" action="{{ route('shipments.store') }}"
                        ...
                        <div  class="border border-3 p-4 rounded depositData">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="deposit_money" @error('store_id') error-input @enderror required name="money" type="number" step="0.01"
                                    @error('store_id') error-input @enderror class="form-control">
                                @error('money')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea @error('notes') error-input @enderror id="deposit_store_notes" name="notes" class="form-control" id="notes" placeholder="{{ __('translation.Add Notes') }}" rows="3"></textarea>
                                 @error('notes')
                                    <div class="error-validation">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="border border-3 mt-4 p-4 rounded">
                            ...
                            <div class="mb-3">
                                ...
                                <input @error('client_name') error-input @enderror id="deposit_client_name" required required name="client_name" type="text"
                                     class="form-control">
                                @error('client_name')
                                    <div class="error-validation">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input @error('client_phone') error-input @enderror id="deposit_client_phone" required name="client_phone" type="text" @error('client_phone') error-input @enderror
                                    class="form-control">
                                @error('client_phone')
                                    <div class="error-validation">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input @error('client_other_phone') error-input @enderror id="deposit_client_other_phone"  name="client_other_phone" type="text"
                                    class="form-control">
                            ...
                            <div>
                                ...
                                <textarea @error('client_address') error-input @enderror id="deposit_client_address" name="client_address" required class="form-control" id="deposit_client_address" placeholder="{{ __('translation.Add Address') }}" rows="3"></textarea>
