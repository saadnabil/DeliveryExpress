...
@section('content')
    <div class="card">
        <div class="card-body p-4">
            ...
            <div class="row">
                <div class="col-lg-8">
                    @include('dashboard.shipments.editForms.depositShipmentForm')
                    @include('dashboard.shipments.editForms.newShipmentForm')
                    @include('dashboard.shipments.editForms.replacementShipmentForm')
                </div>
                <div class="col-lg-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-grid">
                                            ...
                                            @endphp
                                            <button form="{{ old('shipment_type_id',$shipment->shipment_type_id) ? $shipmentTypes[old('shipment_type_id',$shipment->shipment_type_id)] : 'newShipmentForm'  }}" type="submit"
                    ...
                    @if($shipment->shipment_type_id != 3)
