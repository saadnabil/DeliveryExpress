...
@section('content')
    <div class="card">
        <div class="card-body p-4">
            ...
            <hr />
            <form class="form-body mt-4" method="post" action="{{ route('roles.update', $role) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                @method('put')
                <div class="row">
                    <div class="col-lg-8">
                    ...
                    <div class="col-lg-4">
                        <div class="border border-3 p-4 rounded">
                            <div class="mb-3">
                                ...
                                <input required name="name" value="{{ old('name', $role->name) }}" type="text"
